var notification = (function () {
    ...
    module.prototype = {
        ...
        addIosNotification: function(ctx){
            ...
            if(notifications != null &&  notifications[0] != null) {
                ...
                if(featureCode == "500P") {
                    ...
                    db.query(sqlscripts.notifications.update3, stringify(parsedReceivedData) + "", recivedDate + "", notificationId);
                    ...
                    if(pendingExist) {
                        ...
                        db.query(sqlscripts.notifications.update4, notificationId);
                    ...
                    db.query(sqlscripts.notifications.update5, stringify(formattedData) +"", recivedDate+"", identifier);

                } else {
                    var policySeperator = identifier.indexOf("-");

                    if(policySeperator == -1) {
                        db.query(sqlscripts.notifications.update5, ctx.data+"", recivedDate+"", identifier);
                    }
        ...
        addNotification: function(ctx){
            ...
            if(featureCode == "501P"){
                try{
                    db.query(sqlscripts.notifications.delete2, deviceId, featureCode);
                }catch(e){
                    log.info(e);
                }
            }
            var messageIDs = db.query(sqlscripts.devices.select1, ctx.msgID);
            if(typeof messageIDs !== 'undefined' && messageIDs !== null && typeof messageIDs[0] !== 'undefined' && messageIDs[0]!== null){
                db.query(sqlscripts.notifications.update5, ctx.data, recivedDate, ctx.msgID);
            }
        },
        ...
        getPolicyComplianceDevices:function(ctx){
            ...
            var devices = db.query(sqlscripts.devices.select23);
        ...
        getPolicyComplianceDevicesCount:function(ctx){
            ...
            db.query(sqlscripts.notifications.update6, deviceId, featureCode, userId);
        }

var dashboard = (function () {
    ...
    module.prototype = {
        ...
        getAllDevices: function(ctx){
            var result1 = db.query(sqlscripts.platforms.select1);
            var finalResult = {};
            finalResult.count=result1;

            var array = new Array();

            var byodCount = db.query(sqlscripts.devices.select2);
            var obj1 = {};
            obj1.name = "BYOD";
            //obj1.color = "#F17C37";
            ...
            var ownCount = db.query(sqlscripts.devices.select3);
            var obj2 = {};
            obj2.name = "Cooperate";
            //obj2.color = "#F17C37";
            ...
            var byodCountAndroid = db.query(sqlscripts.devices.select4);
            ...
            var ownCountAndroid = db.query(sqlscripts.devices.select5);
            ...
            var Androidversions = db.query(sqlscripts.devices.select6);
            ...
            var byodCountAndroid = db.query(sqlscripts.devices.select7);
            var byodAndroid = byodCountAndroid[0].byodCountAndroid;
            if(byodAndroid == null){
                byodAndroid = 0;
            }
            ...
            var ownCountAndroid = db.query(sqlscripts.devices.select8);
            var nonByodAndroid = ownCountAndroid[0].ownCountAndroid;
            if(nonByodAndroid == null){
                nonByodAndroid = 0;
            }
            ...
            var Androidversions = db.query(sqlscripts.devices.select9);
            ...
            var resultOS = db.query(sqlscripts.platforms.select2);
            var androidCount = 0;
            var iosCount = 0;
            var winCount = 0;
            if(resultOS[0] != null){
            ...
            var resultVer = db.query(sqlscripts.platforms.select3);
            var androidVersions={};
            var iOSVersions={};
            var winVersions={};
            ...
            var resultType = db.query(sqlscripts.platforms.select4);
            var androidTypes={};
            var iOSTypes={};
            var winTypes={};
            ...
            var resultByod = db.query(sqlscripts.platforms.select5);
            var androidBYOD={};
            var iOSBYOD={};
            var winBYOD={};
            ...
            var resultVendor = db.query(sqlscripts.platforms.select6);
            var androidVendors={};
            var iOSVendors={};
            var winVendors={};
